...
import {ChromePickerComponent} from '@iplab/ngx-color-picker';
...
@Component({
  ...
  standalone: true,
  imports: [SidebarActionsComponent, NgSelectModule, FormsModule, ChromePickerComponent, ColorPickerComponent]
})
