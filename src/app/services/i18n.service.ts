...
export class I18nService {
    ...
    get(text: string): string {
        if (!TRANSLATIONS[this.current]) { return text; }
        if (!TRANSLATIONS[this.current][text]) { return text; }
...
const TRANSLATIONS = {
    en: {
        ...
        fav: 'Favorites',
        options: 'Settings',
        gotoDeepSee: 'Navigate to DeepSee Zen',
    ...
    ru: {
        ...
        fav: 'Избраное',
        options: 'Настройки',
        gotoDeepSee: 'Перейти к DeepSee Zen',
