...
const TRANSLATIONS = {
  en: {
    ...
    filtersAffectingList: 'Filters affecting this list',
    clearFilterSelection: 'Clear selection',
    disableTilePush: 'Disable tile pushing when moving/resizing',
    theme: 'Theme',
    showLog: 'Show log',
    server: 'Server',
  ...
  ru: {
    ...
    filtersAffectingList: 'Учитываются фильтры',
    clearFilterSelection: 'Сбросить выбор',
    disableTilePush: 'Отключить выталкивание тайлов',
    theme: 'Тема',
  ...
  pt: {
    ...
    filtersAffectingList: 'Filtros que afetam esta lista',
    clearFilterSelection: 'Limpar seleção',
